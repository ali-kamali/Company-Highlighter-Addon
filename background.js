const companies = [
    ...
    "A.R. Management & Consultancy B.V.",
    ...
    "ABC Consultancy & Detachering B.V.",
    ...
    "Account 4 B.V.",
    "Accountantskantoor Van Stee B.V.",
    "Accres Select B.V.",
    "Accrès Tandartsenpraktijk Purmerend B.V.",
    "Accucoms International B.V.",
    "Accuracy Corporate Financial Advisory",
    "Acda RPA Consultancy B.V.",
    ...
    "ACT Fuels B.V.",
    "Act-3D B.V.",
    "Acta Marine Management Services B.V.",
    "ACTA* Holding B.V.",
    "Actief Techniek B.V.",
    ...
    "adapa the Netherlands Amersfoort B.V.",
    "ADAPTFY B.V.",
    "ADASTEC B.V.",
    ...
    "Advocate Benelux Field Marketing B.V.",
    "Adyen N.V.",
    "AECOM Netherlands B.V.",
    "Aectual B.V.",
    "AEG Power Solutions B.V.",
    "AEGIR-Marine Employment Services B.V.",
    ...
    "AES International B.V.",
    "Aesis B.V.",
    "Aevitas Property Partners Coöperatief U.A.",
    "Afa Dispensing Group B.V.",
    "AFC Ajax N.V.",
    "AFCONA Additives B.V.",
    "Affidea B.V.",
    "Affinius Capital Europe B.V.",
    "AFHCo Stores Netherlands B.V.",
    "African Asset Finance Company Holdings B.V.",
    ...
    "AgiLight B.V.",
    "Agiliz B.V.",
    "Agium Financiële Detachering B.V.",
    "Agora Zaanstreek",
    "Agracom B.V.",
    "Agrico B.V.",
    "Agricultural Production & Handling B.V.",
    ...
    "AL International Transport & Logistics B.V.",
    "A-Label IT B.V.",
    "AlAlim Legal B.V.",
    "Albelli B.V.",
    "Albert Heijn B.V.",
    ...
    "Alicat Scientific B.V.",
    "Alicia Insurance B.V.",
    "Align B.V.",
    "Align Matters B.V.",
    "Align Netherlands B.V.",
    "Align Technology B.V.",
    "Alimentiv B.V.",
    "Aliter Networks B.V.",
    "Al-Khier Food B.V.",
    "Alkion Terminals B.V.",
    "All Capital Holding B.V.",
    "All Trading B.V.",
    "ALL2MD B.V.",
    "All4Trade B.V.",
    ...
    "Alphatron Medical Innovations B.V.",
    ...
    "AMCO Solutions B.V.",
    "Amcor Specialty Cartons Brabant B.V.",
    "Amdocs B.V.",
    "Amelia NL B.V.",
    "America II Europe B.V.",
    ...
    "Anomaly B.V.",
    "Anopanel B.V.",
    "Anotech Energy Netherlands B.V.",
    "AnQore B.V.",
    "Anritsu Infivis B.V.",
    "Ans Exam B.V.",
    "ANSINGER B.V.",
    ...
    "Antlia Advies en Consultancy B.V.",
    "Anton Paar Netherlands B.V.",
    "Anvil Ventures The Netherlands B.V.",
    "ANWB B.V.",
    "ANWB Reizen B.V.",
    "ANWB Retail B.V.",
    "Anyone.com B.V.",
    ...
    "Asc Academics B.V.",
    "ASCI Netherlands B.V.",
    "Ascom (Nederland) B.V.",
    "ASE NL Service Center B.V.",
    "Asfalt Productie Tiel (APT) B.V.",
    "Ashland Industries Nederland B.V.",
    "Ashland Services",
    "Asica Group B.V.",
    "ASICS Europe B.V.",
    "ASICS Technology B.V.",
    ...
    "Assent Compliance Netherlands B.V.",
    "Assertive Yield B.V.",
    ...
    "Atelier Eindhoven B.V.",
    "ATENSUS Detachering B.V.",
    "ATG Engineering B.V.",
    "ATG Netherlands B.V.",
    "AthenaStudies B.V.",
    ...
    "Atos International Global Functions B.V.",
    ...
    "AVEVA Select Benelux B.V.",
    "AVEVA Software Netherlands B.V.",
    "Aveza Industrial Automation",
    "AVH Dairy Trade B.V.",
    "Aviaco Nederland B.V.",
    "Aviator Netherlands B.V.",
    "Avient Colorants Netherlands B.V.",
    "Avignon Capital Netherlands B.V.",
    "Aviko B.V.",
    "Avion B.V.",
    "Avisi Cloud Services B.V.",
    "Avit Group B.V.",
    ...
    "BackOffice Associates NL B.V.",
    "Badenoch + Clark B.V.",
    "BAF Group B.V.",
    "Baffinland Iron Mines Europe B.V.",
    "Baggerbedrijf De Boer",
    "Baggermaatschappij Boskalis B.V.",
    "Bagira Netherlands B.V.",
    "Bain & Company Netherlands LLC",
    "Baker & McKenzie Amsterdam N.V.",
    "Baker Atlas",
    "Baker Hughes Energy International B.V.",
    ...
    "Bakker Magnetics Renewable B.V.",
    "Bakker Repair B.V.",
    ...
    "Barth Industrial Automation B.V.",
    "BAS Mining Trucks B.V.",
    "BAS Truck Center B.V.",
    "BAS Uitzenden en ZZP B.V.",
    "BAS World B.V.",
    ...
    "BENK PROJECTS B.V.",
    "Bennet & Boss B.V.",
    "Bennet & Boss Netherlands B.V.",
    "BenninkAmar Advocaten B.V.",
    "Benq Europe B.V.",
    ...
    "Bertschi B.V.",
    "Beson Distributie B.V.",
    "Beson Post B.V.",
    "Best of Worlds B.V.",
    "BESTMIX Software B.V.",
    ...
    "Big Adventure Travel Company B.V.",
    "BigCommerce Netherlands B.V.",
    ...
    "BioActor B.V.",
    "Bioclear earth B.V.",
    "Biogas Plus Systems B.V.",
    "Biogen Netherlands B.V.",
    "BioGeneration III Services B.V.",
    "BioGX B.V.",
    "Bio-ITech B.V.",
    "Biomedical Distribution North Europe B.V.",
    ...
    "Biosynth B.V.",
    "Biota Nutrients B.V.",
    "Biotisk Energier Netherlands B.V.",
    "BioTop Medical",
    ...
    "Blackstone Shipping Netherlands B.V.",
    "Blanco Services B.V.",
    "Blanq Labs B.V.",
    ...
    "Blox B.V.",
    "Blu-3 (UK) Ltd",
    "Blue Billywig International B.V.",
    ...
    "Blue Phoenix Group",
    "Blue Radix B.V.",
    "Blue Rose Technologies B.V.",
    "Blue Sphere Brabant",
    "Blue Umbrella",
    "Blue Water Shipping B.V.",
    "Blue21 B.V.",
    "BlueAlp Production B.V.",
    "BlueBee",
    "Blueberry ICT B.V.",
    ...
    "BNP Paribas Real Estate Advisory Netherlands B.V.",
    "BNP Paribas SA, Netherlands Branch",
    "BNR-Quality B.V.",
    "BO18 B.V.",
    "BoCari International B.V.",
    ...
    "Bol Accountants B.V.",
    "Bol.com B.V.",
    "Bold Capital Management B.V.",
    "Bold Online B.V.",
    "Bold Security Technology B.V.",
    "Bolder Business Services (Netherlands) B.V.",
    ...
    "Bosch Energy and Building Solutions B.V.",
    ...
    "Bose Products B.V.",
    "Bosing Engineers & Consultants B.V.",
    ...
    "BRAC International Enterprises B.V.",
    ...
    "Brightin B.V.",
    "Brightlands Venture Partners B.V.",
    "Brightsight B.V.",
    "Brimit B.V.",
    "Bring Cargo B.V.",
    "Brink & Hoek Amsterdam B.V.",
    "Brinkman International B.V.",
    "Brink's Solutions Holdings B.V.",
    ...
    "Buro Sant en Co",
    "Burton Hamfelt Urban Architecture B.V.",
    ...
    "C Teleport B.V.",
    "C&E Development B.V.",
    "C&J International Trading B.V.",
    "C. Fleet Supervision B.V.",
    ...
    "Cainiao Supply Chain Netherlands B.V.",
    "Cairn Real Estate B.V.",
    "Çak Textile B.V.",
    "CAL Consult Nederland B.V.",
    "Calcit Zeeland B.V.",
    "Caldic B.V.",
    "CALIBER TECHNOLOGIES B.V.",
    "Caliber.global B.V.",
    "Çalik Denim B.V.",
    "Callisto Integration Europe B.V.",
    "Callisto Web Solutions B.V.",
    "Calvin Klein Europe B.V.",
    "CAM Bioceramics B.V.",
    "Cameo Global B.V.",
    "Camping De Robbenjager B.V.",
    "Camposol Fresh B.V",
    "Campuskey B.V.",
    ...
    "Canon Medical Informatics B.V.",
    "Canon Medical Informatics Europe B.V.",
    "Canon Medical Systems Europe B.V.",
    "Canon Production Printing Netherlands B.V.",
    "CAN-PACK Netherlands B.V.",
    "CANSO B.V.",
    "Canyon Nederland B.V.",
    "Caotech B.V.",
    "Capayable B.V.",
    "Cape Five NL B.V.",
    ...
    "Capte B.V.",
    "CaptureTech Products B.V.",
    "Carat Nederland B.V.",
    "CarbExplore Research B.V.",
    "Carbon Trust Europe B.V.",
    "CarbonX B.V.",
    "Carbyon B.V.",
    ...
    "CBRE Investment Management Indirect Holding B.V.",
    "CBRE Investment Management Personnel Services B.V.",
    ...
    "CEE-BIG B.V.",
    "Cefetra Group B.V.",
    "Cegeka Business Solutions Real Estate Software B.V.",
    "Cegeka Nederland",
    "Celanese Europe B.V.",
    ...
    "Centrum voor Tandheelkunde Maarheeze B.V.",
    "Century Distribution Systems (Europe) B.V.",
    "Cepheid Netherlands B.V.",
    "Ceradis B.V.",
    "Cerberus Global Investments B.V.",
    "Cerence B.V.",
    "CerQlar Solutions Group B.V.",
    ...
    "Charlie works crew B.V.",
    "Chartboost B.V.",
    "Châteraisé Europe B.V.",
    "CHE B.V.",
    ...
    "Chemploy B.V.",
    "ChemPoint.com EMEA B.V.",
    "Chemship B.V.",
    "Chep Benelux Nederland B.V.",
    ...
    "CHINT Electrics Netherlands B.V.",
    "Chiquita Europe B.V.",
    "ChiroBalance",
    "Chiropractie Borger",
    "Chiropractie Castricum B.V.",
    "Chiropractie Centraal B.V.",
    "Chiropractie De Pijp",
    "Chiropractie Den Haag B.V.",
    "Chiropractie Doetinchem B.V.",
    ...
    "Chiropractie Westland B.V.",
    "Chiropractie Wijchen",
    "Chiropractie Wolters B.V.",
    ...
    "CISN Management Company Netherlands B.V.",
    ...
    "Clafis Engineering Midden-Zuid B.V.",
    "Clarify B.V.",
    ...
    "ClearBlue Markets Europe B.V.",
    "Cleeng B.V.",
    "Clever Conductors B.V.",
    "CleverFranke B.V.",
    "cleversoft supervisory reporting B.V.",
    "CLEVR NL B.V.",
    "Click Crew Media B.V.",
    "ClickDealer Europe B.V.",
    "ClickDimensions, LLC",
    "ClickFox, Inc.",
    "ClickHouse B.V.",
    "Clifford Chance LLP",
    ...
    "Climate Neutral Group B.V.",
    "Climate Risk Services B.V.",
    ...
    "Close Contact B.V.",
    "Cloud Life B.V.",
    "Cloud Software Group Netherlands B.V.",
    "Cloud Solutions Nederland B.V.",
    "Cloud Team Company",
    "Cloudator B.V.",
    "CloudBilling B.V.",
    "Cloudfactory B.V.",
    ...
    "Coco Yachts B.V.",
    "Cocoanect B.V.",
    "Coda Netherlands Holdings B.V.",
    "Code d'Azur Interactive B.V.",
    "Code Internet Applications B.V.",
    "Code Nomads B.V.",
    "Code Nomads Rotterdam B.V.",
    "Code Nomads Utrecht B.V.",
    "Code Orange B.V.",
    "Code Product Solutions B.V.",
    "Code Yellow B.V.",
    "Codean B.V.",
    "Codeclan Den Bosch B.V.",
    "Codeglue B.V.",
    "CodeSandbox B.V.",
    "CodeShop B.V.",
    "Codit Nederland B.V.",
    ...
    "Compusult Europe B.V.",
    "Computer Packages Europe B.V.",
    "Computest Consultancy B.V.",
    ...
    "Constructie- en Aannemingsbedrijf Peter de Kok B.V.",
    ...
    "Continu",
    "Continuous Events B.V.",
    "Contiweb B.V.",
    "Contractuo Nederland B.V.",
    "Control Payroll B.V.",
    ...
    "Conversation Studio B.V.",
    "Converse Netherlands B.V.",
    "Convesting B.V.",
    "Convious",
    "Conway & Partners N.V.",
    "ConXys Technologies International B.V.",
    ...
    "Copiatek Scan & Computer Solution B.V.",
    "Copier Engineering B.V.",
    "Copius (NI) Ltd",
    "Coraltech B.V.",
    "Cordstrap B.V.",
    "Core Avionics & Industrial HR B.V.",
    ...
    "Corion B.V.",
    "Cornerstone OnDemand Europe Netherlands B.V.",
    "Corning B.V.",
    "Corpag Holding B.V.",
    "Corpag Services (Netherlands) B.V.",
    "Corparis",
    "Corporate Communication Centre B.V.",
    "Corrosion Laboratory B.V.",
    "Corsano Health B.V.",
    "Corsearch B.V.",
    ...
    "Countr International B.V.",
    "Coveo (Europe) B.V.",
    "Cover Genius Europe B.V.",
    ...
    "CropIn Technology Solutions B.V.",
    ...
    "Cubematch B.V.",
    "Cuccibu B.V.",
    "Cuccibu Consultancy Services B.V.",
    "Cullinan Academy B.V.",
    "Cultivation Systems B.V.",
    "Cultivators B.V.",
    "Cummins Holland B.V.",
    "Curado Trust (Nederland) B.V.",
    "Curavista B.V.",
    "CureSupport Nederland B.V.",
    "CureVac Netherlands B.V.",
    "Curgoal",
    "Currency Cloud Services B.V.",
    "Curvature LLC",
    "Customized Energy Solutions Europe B.V.",
    ...
    "D.P. Supply B.V.",
    "D.Q.A. Pharma International B.V.",
    "D/DOCK B.V.",
    "D2D Holding B.V.",
    "D2X Group N.V.",
    ...
    "Daiwa Kasei Europe B.V.",
    "Daksh B.V.",
    "Daksha Consultancy B.V.",
    "Dallas Netherlands Cooperative U.A.",
    "Dalsem B.V.",
    "Dam 9 B.V.",
    "Damen Civil & Modular Constructions B.V.",
    "Damen Dredging Equipment B.V.",
    "Damen Global Support B.V.",
    "Damen Marine Components Netherlands B.V.",
    "Damen Offshore & Specialized Vessels B.V.",
    "Damen Research Development & Innovation B.V.",
    ...
    "Darling Ingredients International IT Services B.V.",
    "DART Aerospace B.V.",
    ...
    "DAT.Mobility B.V.",
    "Data eXcellence B.V.",
    "Data2Logistics Europe B.V.",
    "Databricks",
    "Datacation B.V.",
    "Data-Centric Engineering B.V.",
    "Datadog Netherlands B.V.",
    "Dataflex International B.V.",
    "Dataiku B.V.",
    "DataLane B.V.",
    "DataLyzer International B.V.",
    "DataPebbles B.V.",
    "DataProphet International Operations B.V.",
    "DataSnipper B.V.",
    "Datavideo Technologies Europe B.V.",
    "Datenna B.V.",
    "DatHuis B.V.",
    "Datlinq",
    "DATUM SOLUTIONS NETHERLANDS B.V.",
    ...
    "Deckers Benelux B.V.",
    "Decos Software Development B.V.",
    ...
    "Defesche Van den Putte architectuur en stedenbouw B.V.",
    "DEG Groep B.V.",
    "DEHA B.V.",
    "Déhora advies B.V.",
    "DEITYcommerce B.V.",
    ...
    "Delpharm Development Leiden B.V.",
    "Delphy B.V.",
    ...
    "DEMCON high-tech systems Enschede B.V.",
    "DEMCON kryoz B.V.",
    "DEMCON life sciences & health Delft B.V.",
    "DEMCON life sciences & health Eindhoven B.V.",
    ...
    "Dental Clinics Veenendaal B.V.",
    "Dental Robotics B.V.",
    "DENTAL Universe B.V.",
    "Dental365 Rotterdam B.V.",
    "Dentons Europe LLP",
    "Dentons Europe LLP",
    ...
    "Desah B.V.",
    "DeSci Labs Netherlands B.V.",
    "Design Associates B.V.",
    ...
    "Deutsche Telekom Global Business Solutions Nederland B.V.",
    "Developers.nl B.V.",
    ...
    "DFDS Distri Holding B.V.",
    "DFDS Logistics Winterswijk B.V.",
    "DFE Pharma B.V.",
    "DFFRNT LAB B.V.",
    "DFFRNT Media B.V.",
    "DFM N.V.",
    ...
    "Dierenkliniek Hoogveld B.V.",
    "DIF Management B.V.",
    "digi.bio B.V.",
    "Digidentity B.V.",
    "DigiGamma B.V.",
    "DIGIO ICT B.V.",
    "Digireg Netherlands B.V.",
    "DigiSure B.V.",
    "Digital Decisions B.V.",
    "Digital Matter B.V.",
    "Digital Power Technologies B.V.",
    ...
    "Dozon B.V.",
    "DP World Inland B.V.",
    "DP World Logistics Europe B.V.",
    "DP World Logistics Netherlands B.V.",
    ...
    "Drie Sterren Infra B.V.",
    "Drieam B.V.",
    "Driessen Catering Equipment B.V.",
    ...
    "Dutch Drone Gods B.V.",
    "Dutch Medical Food B.V.",
    "Dutch Payroll Experts B.V.",
    "Dutch Qargo B.V.",
    "Dutch Real Estate Company Amsterdam B.V.",
    "Dutch Recruitment Service B.V.",
    "Dutch Related Services B.V.",
    "Dutch Sino Business Promotions",
    "dutchfounders.fund B.V.",
    "Dutchina Agro Tech Incubation Center B.V.",
    ...
    "DX Technology Services and Investment B.V.",
    "DXC Technology",
    "DXC Technology",
    "DycoTrade",
    "Dyflex Polymers",
    ...
    "Dynamic Oasis B.V.",
    "Dynamic People B.V.",
    "Dynamic Visual Technologies B.V.",
    ...
    "EasyAds B.V.",
    "Easygenerator B.V.",
    "Easygreen Energy Solutions B.V.",
    ...
    "edilon)(sedra B.V.",
    "Edmond de Rothschild REIM (Benelux) B.V.",
    ...
    "Egeniq B.V.",
    "Egeria Group Services B.V.",
    "Eggerding & Co.",
    "Egypt Solar B.V.",
    "EH Hotel Management B.V.",
    "EHPC Holdings B.V.",
    "Eichholtz B.V.",
    "Eigen Energie.net B.V.",
    "Eijkelkamp Soil & Water B.V.",
    "Eiken Chemical Europe Office",
    "Eimskip Nederland B.V.",
    "Einride Technologies Netherlands B.V.",
    "Eironn Netherlands B.V.",
    "Eisenkolb B.V.",
    ...
    "Electron Performance B.V.",
    "Electron Technologies B.V.",
    "Electronic Arts Nederland B.V.",
    "Electronic Commerce Solutions (ECS) International B.V.",
    ...
    "EMI Twente B.V.",
    "EMIS B.V.",
    "Emixa Integration Solutions B.V.",
    "Emka Infra B.V.",
    "Emmett Green B.V.",
    ...
    "Enable U",
    "EnAppSys B.V.",
    "Enauta Netherlands B.V.",
    "Endeavour B.V.",
    "Endologix International Holdings B.V.",
    "Eneco Diamond Hydrogen B.V.",
    ...
    "Er Shipping Holding B.V.",
    "ERA Nederland N.V.",
    "Eraneos Analytics Netherlands B.V.",
    "Erasmus Centre for Entrepreneurship",
    "Erasmus Centre for Urban, Port and Transport Economics B.V.",
    "Erasmus Enterprise B.V.",
    ...
    "Essange Reagents",
    "Esse B.V.",
    "EssenceMediacom Netherlands B.V.",
    ...
    "Eves B.V.",
    "EVG Start B.V.",
    "Eviden International Global Functions B.V.",
    "Eviden Netherlands B.V.",
    "Evident Interactive B.V.",
    "Evides N.V.",
    "Evidos B.V.",
    "Eviosys Aerosols & Promotional Packaging Netherland B.V.",
    ...
    "Exelerating B.V.",
    "Exes Group B.V.",
    "Exide Technologies B.V.",
    "EXIN Holding B.V.",
    "Exivity B.V.",
    "EXNER INGENIEURSTECHNIEK B.V.",
    ...
    "Experis Professionals B.V.",
    "Experis Staff B.V.",
    "Experlogix B.V.",
    "Expertisebureau HDG B.V.",
    "Expivi Holding B.V.",
    "Expleo Netherlands B.V.",
    "Explicit Selection B.V.",
    "Exploitatie Pillows MK61 B.V.",
    ...
    "Faculty of Skills",
    "Fagron B.V.",
    "Fagron Holding EMEA B.V.",
    "Fair Consulting Netherlands B.V.",
    "Fairbanks B.V.",
    "FairChainTech B.V.",
    "Faire Wholesale B.V.",
    ...
    "FBD International B.V.",
    "FC C.V.",
    "FCA Netherlands B.V.",
    "FCC Construccion S.A.",
    "FCPM III Services B.V.",
    "Feddes/Olthof Landschapsarchitecten B.V.",
    ...
    "FIFPro Holding B.V.",
    "Figma Netherlands B.V.",
    "Figo B.V.",
    "Filasflex Uitzendbureau B.V.",
    "Fimble B.V.",
    ...
    "FindHotel B.V.",
    "FinDock B.V.",
    "FinMechanics Netherlands B.V.",
    "FINOM Payments B.V.",
    "Finqle B.V.",
    "Finst B.V.",
    "FinStack Holding B.V.",
    "Finthropology B.V.",
    "Finwerd B.V.",
    "Firat Bakkerij B.V.",
    "Firemane B.V.",
    ...
    "Five Rings Capital B.V.",
    "FixedToday 52 B.V.",
    "FixedToday B.V.",
    "Fixico B.V.",
    "Fizyr",
    "Flagship Advisory Partners B.V.",
    ...
    "Flexible Packaging Combination B.V.",
    "FlexiiDrive B.V.",
    "Flexn B.V.",
    "Flexous B.V.",
    ...
    "Flexxy B.V.",
    "Flight Centre Travel Group (Netherlands) B.V.",
    "Flinndal B.V.",
    "fLinqer B.V.",
    ...
    "Flutterwave Netherlands B.V.",
    "Flux Groep B.V.",
    "Flux Landscape Architecture B.V.",
    "Flying Fish Water Mobility B.V.",
    "Flynth Audit B.V.",
    "FLYR Netherlands B.V.",
    "Flytxt B.V.",
    "FM Group Human Resources B.V.",
    "FM Insurance Company Ltd.The Netherlands Branch",
    "FM Insurance Europe S.A.",
    "FM Plastics B.V.",
    "FMC Separation Systems B.V.",
    "FM's Dienstverlening B.V.",
    "fnCyber Security Consulting Services B.V.",
    "FNsteel B.V.",
    "Focus B.V.",
    "Focus Engineering B.V.",
    "Focus Enterprise Solutions B.V.",
    "Focus IT People B.V.",
    ...
    "ForceWeb B.V.",
    "Forcyd Managed Review B.V.",
    "Ford Nederland B.V.",
    "Forehand Electronic Extensions B.V.",
    "Forescout Technologies B.V.",
    "Foreside B.V.",
    "ForestEffect Management B.V.",
    "Forever Direct E.U. B.V.",
    "Forexx Group B.V.",
    ...
    "Foxess Netherlands B.V.",
    "Fox-IT",
    "FPE Advisory B.V.",
    "FPS Investments B.V.",
    "FPT Software Netherlands B.V.",
    "FRABA B.V.",
    ...
    "Framo Nederland B.V.",
    "Frank Recruitment Group Netherlands B.V.",
    "Frankort & Koning B.V.",
    "Frank's International Coöperatief U.A.",
    "Franx B.V.",
    "Fratello Watches B.V.",
    "Fraud Dynamics B.V.",
    "Fraudio B.V.",
    "Fredhopper B.V.",
    "Free Engineering B.V.",
    "FREE NOW Netherlands B.V.",
    "Freeday B.V.",
    ...
    "Frisse Blikken ondernemen met talent B.V.",
    ...
    "FrontValue B.V.",
    "Fruitone Europe",
    "FS NL Hilton Rotterdam OpCo 19 B.V.",
    "FST Technology B.V.",
    ...
    "Fyndr B.V.",
    "FysioHolland B.V.",
    "Fysiotherapie De Rietlanden B.V.",
    "Fysiotherapie Weerdsingel West",
    "Fysiowereld",
    "G. Vermes B.V.",
    "G.B. Electronics Limited",
    "G.C. de Jong Construction B.V.",
    "G.I. Dynamics B.V.",
    "G.J. van Olst B.V.",
    "G3 Worldwide Mail",
    ...
    "Gallium Semiconductor Netherlands B.V.",
    "Gamegos B.V.",
    ...
    "Giesecke+Devrient Currency Technology Netherlands B.V.",
    ...
    "GlobalOrange B.V.",
    "Globe Tech B.V.",
    "Glory Global Solutions (Netherlands) B.V.",
    "Glosec NL B.V.",
    "Glow Chiropractic",
    ...
    "Golden Egg Check B.V.",
    "Golden Laser Europe B.V.",
    "Goldman Sachs Bank Europe SE, Amsterdam Branch",
    "Goldman Sachs Personeel B.V.",
    "GoldRepublic B.V.",
    "Gomocha B.V.",
    ...
    "Gracious",
    "Gradyent B.V.",
    "Grafana Labs Netherlands B.V.",
    "Grain Data Consultants B.V.",
    ...
    "GRI-Alleset Limited B.V.",
    "Griesemann Engineering NL B.V.",
    "GRIP B.V.",
    "Gro Design B.V.",
    "Groeneveld - Recruitment B.V.",
    "GroenLeven B.V.",
    ...
    "Grutto B.V.",
    "Gs Holding B.V.",
    "GS Netherlands Onsite ManCo B.V.",
    "GSES Management B.V.",
    "GSH Klusbedrijf",
    "GSK Vaccines B.V.",
    ...
    "Guido de Groot Design B.V.",
    "Gulf Agency Company (Holdings) B.V.",
    "Gulf Turbo Solutions B.V.",
    ...
    "Haicheng Mobile Company (Netherlands) B.V.",
    ...
    "Halal Correct Auditing Services B.V. (HCAS).",
    "Halal Voeding en Voedsel Keuringsdienst (Halal Feed and Food Inspection Authority) B.V.",
    "Halavet B.V.",
    ...
    "Handelsonderneming Steboma B.V.",
    ...
    "Headlands Technologies Europe B.V.",
    "Health Angels B.V.",
    "Health Kliniek",
    "Health Net TPO",
    "HealthCity West B.V.",
    ...
    "Heerema Engineering Solutions B.V.",
    ...
    "Het Droompaleis B.V.",
    "Heuschen & Schrouff Foods Group B.V.",
    "Heusschen*Copier Stad + Landschap",
    "Heussen",
    "Hewlett-Packard Nederland B.V.",
    "HewSaw International B.V.",
    "Hexing Europe B.V.",
    "Hexion VAD B.V.",
    "Hey Honey B.V.",
    "HHOYA B.V.",
    ...
    "Hibino Europe B.V.",
    "High Eye B.V.",
    "High Quality Interim Personeel B.V.",
    "High Quality Music Publishing Company B.V.",
    "High Tech Source B.V.",
    ...
    "Hillebrand Gori IT B.V.",
    "Hillel Hospitality GP B.V.",
    "Hill's Pet Nutrition Manufacturing B.V.",
    "Hilti Nederland B.V.",
    "Hilton Foods Holland",
    "Hilton International Nederland B.V.",
    "Hines Netherlands B.V.",
    "Hinicio N.V.",
    "HIP B.V.",
    "Hiranyavarnaam Alkalis B.V.",
    ...
    "Homerun B.V.",
    "Homewizard B.V.",
    "Hommema Bliksembeveiliging B.V.",
    "Honeypot",
    "Honeywell B.V.",
    ...
    "Hopmans FlexStay B.V.",
    "Hopper Engineering and Consultancy B.V.",
    "Hopper Netherlands B.V.",
    "Hoppinger",
    "HORAIZON technology B.V.",
    "Horecagroep Breda Holding B.V.",
    ...
    "Hotel Seasons B.V.",
    "Hotel Villa Ruimzicht B.V.",
    "Hotel Winston",
    "Hotelchamp B.V.",
    "Hotelschool The Hague",
    "Hotmart B.V.",
    "Hotmart Technology Holding B.V.",
    "Hotraco Agri B.V.",
    ...
    "Huisman Fabrication Personnel B.V.",
    ...
    "I & C Services B.V.",
    "I AM POP B.V.",
    "I Hate Statistics B.V.",
    "I.A.A. Architecten B.V.",
    "I.D.B. Holland B.V.",
    "i+ Solutions",
    "i2d consulting B.V.",
    "i2i B.V.",
    "i3D.net B.V.",
    "i4talent professional B.V.",
    "i8c B.V.",
    "IA Shared Services B.V.",
    "IACT B.V.",
    ...
    "ILX Management",
    "im | innovating B.V.",
    "IM Efficiency Technologies B.V.",
    "IMAgency B.V.",
    "Imagr B.V.",
    "Imbull B.V.",
    "IMBV B.V.",
    ...
    "Independent Energy B.V.",
    "Independent IP B.V.",
    "Independent Recruiters Flex B.V.",
    "Independer",
    "Index Hospitality Systems B.V.",
    "INDG Digitale Communicatie B.V.",
    "India Palace Restaurant B.V.",
    "Indian Food Factory B.V.",
    ...
    "Ingenieursbureau Kok & van den Heuvel B.V.",
    "Ingenieursbureau List B.V.",
    ...
    "INND Batteries B.V.",
    "INNET B.V.",
    "INNIO Jenbacher International B.V.",
    "INNIO Jenbacher Netherlands B.V.",
    "INNOBIO Europe B.V.",
    "InnoBTech Solutions B.V.",
    "Innocent B.V.",
    "Innocom (I.T.) B.V.",
    ...
    "Innopay NL B.V.",
    "Innoptus Netherlands B.V.",
    "Innoseis Holding B.V.",
    "InnoSyn B.V.",
    "InnoTractor B.V.",
    "Innova Market Insights B.V.",
    "Innovatec Utrecht Holland",
    "INNOVATEST Europe",
    "Innovation Gateway Nederland B.V.",
    ...
    "InSided B.V.",
    "Insider Benelux B.V.",
    "insideRESOURCING B.V.",
    "Insify Holding B.V.",
    "Insightometrics B.V.",
    "insightsoftware Netherlands B.V.",
    "InsingerGilissen, a Quintet Private Bank (Europe) S.A. branch",
    "InSites Consulting B.V.",
    "Insmed Netherlands B.V.",
    "INSPX",
    "Installatiebedrijf Gebr. Janssen B.V.",
    "Instamat Warmtetechniek B.V.",
    "Instant Development B.V.",
    "Instant NanoBiosensors B.V.",
    ...
    "Intelligent Vision Engineers B.V.",
    "Intelligenz IT B.V.",
    "Intenda Europe B.V.",
    "Inter Chiro B.V.",
    ...
    "InterMetro Industries B.V.",
    "Intermission Film Europe B.V.",
    ...
    "International Brands Group B.V.",
    "International Confederation of Midwives",
    "International Congress and Convention Association (ICCA).",
    "International Development of Technology B.V.",
    "International Direct Sourcing B.V.",
    ...
    "International Law Firm Taheri B.V.",
    ...
    "International Wellness Resorts B.V.",
    ...
    "Internova Professional Lighting B.V.",
    "Intero Integrity Services",
    "InterQuest Europe B.V.",
    "Intersafe Netherlands B.V.",
    "Interscience B.V.",
    ...
    "IQVIA Solutions B.V.",
    "Ir. Olav's Globetrotters B.V.",
    "Irdeto B.V.",
    "IReckon B.V.",
    "Iris Ohyama Europe B.V.",
    "IRM Europe B.V.",
    "IRM Systems B.V.",
    "Iron Mountain (Nederland) Services B.V.",
    ...
    "Juma International B.V.",
    "Jumbo Supermarkt",
    "Jump Trading Europe B.V.",
    "Jungle Gym B.V.",
    "Jungle Minds B.V.",
    "Juniper Networks International B.V.",
    "Just Ride Logistics B.V.",
    "Just-BI B.V.",
    ...
    "Kaak Food Processing Systems B.V.",
    "KAAN Architecten B.V.",
    "Kaasmakerij De Jong B.V.",
    "Kaasmakerij Özgazi B.V.",
    "Kadans Holding B.V.",
    "Kadaster",
    ...
    "Kasirga Beheer B.V.",
    "Kassen-Verwarmingsindustrie Gakon B.V.",
    "Katanox B.V.",
    "Kato Europe B.V.",
    "Kaustik Europe B.V.",
    "Kavel 10 B.V.",
    ...
    "KERN Engineers B.V.",
    "Kernel B.V.",
    "Kerridge Commercial Systems (KNV) B.V.",
    "Kerry (NL) B.V.",
    "Kerry Logistics (Netherlands) B.V.",
    "Kersten Beheer en Onderhoud B.V.",
    ...
    "Key Hospitality B.V.",
    "Key Quantum International B.V.",
    "Key Technology B.V.",
    "Keylane B.V.",
    "Keylane Life and Pension B.V.",
    "KeyOn B.V.",
    "Keystone Europe B.V.",
    ...
    "Kinaxis Europe B.V.",
    "Kinderdagverblijf Sam & Kids B.V.",
    "Kinesso B.V.",
    "KINETI B.V.",
    "Kinetron",
    ...
    "Klarrio B.V.",
    "KlaverOmega B.V.",
    "Klein Nederland Trading B.V.",
    "Klever Mobility NL B.V.",
    "KLG Europe Venlo B.V.",
    "Klikkie B.V.",
    "Klimhal Amsterdam B.V.",
    ...
    "Koenig Solutions B.V.",
    "Koike Europe B.V.",
    "Kok Experience Harderwijk B.V.",
    "Koks Group B.V.",
    ...
    "Kozuki Holding B.V.",
    "KPI OceanConnect B.V.",
    "KPIC Netherlands B.V.",
    "KPIT Technologies Netherlands B.V.",
    "KPMG Staffing & Facility Services B.V.",
    "KPN",
    "KPS Netherlands Management B.V.",
    "Kraaijeveld Coppus Koelewijn Accountants & Advisors B.V.",
    ...
    "Krauthammer International Netherlands B.V.",
    ...
    "KZA B.V.",
    "L - founders of loyalty Group B.V.",
    ...
    "Legionfarm Operations B.V.",
    "Legrand AV Netherlands B.V.",
    "Leiden Cryogenics B.V.",
    "Leidos, Inc.",
    "Leids Universitair Medisch Centrum (LUMC)",
    "Leisure Expert Group B.V.",
    "Leisure International Nederland B.V.",
    "Lejeune Association Management B.V.",
    "LEKKER international B.V.",
    "Lely Industries N.V.",
    ...
    "LeoSat B.V.",
    "Les Coyotes de Paris B.V.",
    "LessonUp B.V.",
    "Lestrade Financial Services B.V.",
    "Letink Design B.V.",
    "Lets Blinq B.V.",
    ...
    "LG Sonic B.V.",
    "LGMG Europe B.V.",
    "L-Groep Totaalonderhoud B.V.",
    "LHIC Netherlands II B.V.",
    ...
    "Lipton Teas and Infusions Netherlands B.V.",
    "LIQAL B.V.",
    ...
    "Login VSI B.V.",
    "Logiqs B.V.",
    "Logisch industriële automatisering B.V.",
    ...
    "Lytho B.V.",
    "Lyv B.V.",
    "M Moser Associates B.V.",
    "M Restart",
    "M Restart Secondment & Solutions B.V.",
    "M&C Saatchi B.V.",
    "M&M e-commerce B.V.",
    "M. Velings Holding B.V.",
    "M.I. Maritime B.V.",
    ...
    "Maas Marine & Industrial Equipment B.V.",
    ...
    "Madison People International B.V.",
    "Maersk Line Netherlands B.V.",
    "Maersk Logistics & Services International B.V.",
    "Maersk Logistics and Services Netherlands B.V.",
    "Maestr B.V.",
    "Maeve Aerospace B.V.",
    ...
    "Magnit Global Netherlands BN B.V.",
    "Magno IT B.V.",
    "Magno IT Recruitment B.V.",
    "Magnus Energy B.V.",
    "Magnus Green",
    "Maharishi Ayurveda Europe B.V.",
    "Maiestas Professional Services B.V.",
    "MainBlades Inspections B.V.",
    "Mainetti B.V.",
    "Mainfreight B.V.",
    ...
    "Manpower B.V.",
    "Manpower Flexibility B.V.",
    "Manpower Flexwork B.V.",
    "Manpower Talentworkers B.V.",
    "ManpowerGroup Staff B.V.",
    "Manschap B.V.",
    "Mansource B.V.",
    "MantiSpectra B.V.",
    "Manus Machinae B.V.",
    ...
    "MaplesFS Service Company (Netherlands) B.V.",
    ...
    "MATERIAL PLUS EU B.V.",
    "Materials innovation institute M2i",
    "Mather Economics Netherlands B.V.",
    "Matras Recycling EU Nederland B.V.",
    "Matrix Vastgoed B.V.",
    "Mat-Tech B.V.",
    "Mattel Europa B.V.",
    ...
    "Maxlead Services B.V.",
    "Maxwell and Spark B.V.",
    "Maxwell Continental Tank Serv Engineering B.V.",
    "Maxwell Labs B.V.",
    "Maxxis Europe B.V.",
    ...
    "MBA Michael Bailey Associates Project Services B.V.",
    "MBA Michael Bailey Associates Recruitment B.V.",
    ...
    "MECAL Semiconductor Product Development B.V.",
    ...
    "Medical Research Data Management B.V.",
    ...
    "Medische Haartransplantatie Klinieken B.V.",
    "Mediservice B.V.",
    ...
    "Milcare",
    "Milence Netherlands B.V.",
    "Milence Research & Development B.V.",
    "Milence Service Holding B.V.",
    ...
    "Mitsui Bussan Gas & Power Solutions B.V.",
    ...
    "Mizuno Nederland B.V.",
    "MK Support Service B.V.",
    "MKB Ondernemers B.V.",
    "MKK Europe B.V.",
    "ML Compliance Services B.V.",
    "MLA+ Architecture B.V.",
    "MLA+ B.V.",
    "MLP Newco B.V.",
    "MM Flowers Europe B.V.",
    ...
    "Mondzorg Dogterom B.V.",
    "Mondzorgcentrum Axel B.V.",
    "MoneyView Research B.V.",
    ...
    "Mphasis Europe B.V.",
    "Mploy Associates International B.V.",
    "MPloyee B.V.",
    "MPR Accountants & Consultants B.V.",
    "Mprise Agriware B.V.",
    "Mprise B.V.",
    "MPX Administratie & Advies B.V.",
    "MQD B.V.",
    "MR MARVIS B.V.",
    "mr. B.J. Maes Praktijk B.V.",
    ...
    "NASA Holding B.V.",
    "Nash Exchange B.V.",
    "Nationaal Energie Traineeship B.V.",
    ...
    "NautaDutilh N.V.",
    "Navaio B.V.",
    "Navan Netherlands B.V.",
    "Navan Netherlands Labs B.V.",
    "Navbea B.V.",
    "Navico Group EMEA B.V.",
    "Navico Logistics Europe B.V.",
    "Navigram Technologies B.V.",
    "NavInfo (Europe) B.V.",
    ...
    "Neele-Vat Services B.V.",
    "Neele-Vat Transport B.V.",
    "Neelikon Specialities Europe B.V.",
    "Neenah Coldenhove",
    ...
    "NeoBards Entertainment (Netherlands) B.V.",
    "Neocles B.V.",
    ...
    "NetAxis Nederland B.V.",
    "Netcapital B.V.",
    "Netcompany Netherlands B.V.",
    "Netconomy Netherlands B.V.",
    "NetEconomy",
    "Netfin B.V.",
    "Netflix International B.V.",
    "Netherlandix C.V.",
    "Netherlands center for the Clinical advancement of Stem cell & Gene Therapies B.V.",
    ...
    "Nobel Recruitment B.V.",
    "Nobian Chemicals B.V.",
    "Nobian Industrial Chemicals B.V.",
    "Noble Environmental Benelux B.V.",
    ...
    "Nomi Co-Packing",
    "Nomilk2day Engineering B.V.",
    "Nomios Netherlands B.V.",
    "NOMOBO Talent B.V.",
    "Nomura Europe Finance N.V.",
    "Nomura Financial Products Europe GmbH",
    "Noordboer International Ondernemen B.V.",
    "Noordster Medical Services B.V.",
    "Noordzee International B.V.",
    "Noorman Hendriks Partners B.V.",
    "NoPalm Ingredients B.V.",
    "Nordcloud B.V.",
    "Norden Shipping and Engineering B.V.",
    "Nordex Netherlands B.V.",
    "Nordic Group B.V.",
    ...
    "Northumbria University Amsterdam B.V.",
    ...
    "Obvious People B.V.",
    "OC&C Strategy Consultants B.V.",
    "OCE Nederland B.V.",
    "Ocean Network Express (Netherlands) B.V.",
    "Oceaneering Mobile Robotics B.V.",
    "Oceans of Energy B.V.",
    "Oceanwide Expeditions Holding B.V.",
    ...
    "Odd.Bot",
    "Odd-e Netherlands B.V.",
    "Odido Netherlands B.V.",
    "Odin Warehousing & Logistics B.V.",
    "Odin-RVB Chemicals B.V.",
    "Odura advies en projecten B.V.",
    "Odyssey",
    "Odyssey Almere I B.V.",
    "Odyssey Europe B.V.",
    "Oehoe B.V.",
    "OFD Holding B.V.",
    "Off the Fence B.V.",
    ...
    "OLAM Cocoa",
    "Olam Europe B.V.",
    "Olam Global Agri Brands B.V.",
    "Olam Global Agri Netherlands B.V.",
    "Olam Services",
    "Olba",
    ...
    "Olympic Hotel Amsterdam B.V.",
    "Olyx B.V.",
    "OM Partners Nederland B.V.",
    "Omega Architecten",
    "OMERS Infrastructure European Holdings B.V.",
    ...
    "Oranje Transport B.V.",
    "Oranjedak B.V.",
    "Orbisk B.V.",
    "Orbital Eye B.V",
    "Orbys B.V.",
    "Orchest Software B.V.",
    "Orderchamp B.V.",
    "Ordina Nederland B.V.",
    "Ordina Subscription Management & Utilities B.V.",
    "Ore Energy B.V.",
    "Oreon Holding B.V.",
    "Orffa Additives B.V.",
    "Orga B.V.",
    ...
    "ORTEC Technology B.V.",
    "Ortery Technologies B.V.",
    "Orthocenter B.V.",
    "Orthocenter N.V.",
    "Orthodocs B.V.",
    "Oryx Stainless B.V.",
    ...
    "Oxford Global Resources Solutions B.V.",
    "OXODIAS B.V.",
    ...
    "OZ Export B.V.",
    "OZ Import B.V.",
    "Özbaktat Supermarkt B.V.",
    "P & O Ferrymasters",
    "P&M Netherlands B.V.",
    "P. van der Wegen Gears B.V.",
    "P.M.E.J. Hendrix B.V.",
    "P.M.T. CARGO SMARTPOINT B.V.",
    "P.S.O. Beheer B.V.",
    "P1 Corporate Hospitality",
    "P2 Proces- en Projectmanagers B.V.",
    "PA Imaging R&D B.V.",
    ...
    "Pandora Intelligence B.V.",
    "Pan-Invest B.V.",
    "Panorama Laboratories B.V.",
    "Panteia B.V.",
    "PanTerra GeoConsultants B.V.",
    "PanTerra Geoscience B.V.",
    "PanTerra Laboratory Services B.V.",
    ...
    "ParkBee B.V.",
    "Parker Hannifin Manufacturing Netherlands (Pneumatic) B.V.",
    "Parker Hannifin Manufacturing Netherlands B.V.",
    "Parking Network B.V.",
    "Parkos B.V.",
    "parsionate Benelux B.V.",
    "ParTech IT B.V.",
    "Parthos B.V.",
    ...
    "PassiveLogic Netherlands B.V.",
    "PastBook B.V.",
    "Patagonia Consultants B.V.",
    ...
    "Peloton E.U.B.V.",
    "Pelt & Hooykaas B.V.",
    "Penfield Digital B.V.",
    "Penn Color International B.V.",
    "Penske Logistics Support Services B.V.",
    "Pentair Water Process Technology B.V.",
    "Pentanova Conveyor Systems Nederland B.V.",
    "PenTips B.V.",
    "PEO B.V.",
    ...
    "PGGM N.V.",
    "PGI Nonwovens B.V.",
    "Phaidon International (Netherlands) B.V.",
    ...
    "Philips Oral Healthcare B.V.",
    "PhiX B.V.",
    "Phoenix ME (Netherlands) Ltd",
    "Photanol B.V.",
    "Photonfirst Production & Packaging B.V.",
    ...
    "PHYSEE Group B.V.",
    "PI Benelux B.V.",
    "Piano's Maene Nederland B.V.",
    "Picarro B.V.",
    "Picasse Internet & Mobile B.V.",
    ...
    "Plalloy MTD B.V.",
    "PlanB Europe B.V.",
    "Planet Payment Netherlands B.V.",
    "Planet X FX B.V.",
    "PLANETROMEO B.V.",
    "Planlogic B.V.",
    ...
    "PLAYERUNKNOWN PRODUCTIONS B.V.",
    "Playseats B.V.",
    "Playtika Netherlands B.V.",
    ...
    "POWARE Industrial Automation B.V.",
    "Power Research Electronics B.V.",
    "Power2X Services B.V.",
    "PowerCubes B.V.",
    "Powerdobs B.V.",
    ...
    "Prodrive Technologies N.E. B.V.",
    "Prodrive Technologies Services B.V.",
    ...
    "Profs4U B.V.",
    "Profundo B.V.",
    "Progress Projectmanagement and Engineering B.V.",
    "Progressare B.V.",
    ...
    "Pure Services Lifting Solutions B.V.",
    ...
    "QPS Netherlands B.V.",
    "QSA Aeronautical Engineering Services B.V.",
    ...
    "RAMLAB B.V.",
    "Rand Technology EMEA B.V.",
    "Random Studio B.V.",
    "Randstad Groep Nederland B.V.",
    "Randstad Kelderbouw B.V.",
    "Randstad N.V.",
    ...
    "Reanda Netherlands",
    "Rebel Payments, Mobility & Insights NL B.V.",
    ...
    "Resleeve B.V.",
    "Resn Europe Limited",
    "Resolve Salvage & Fire (Netherlands) B.V.",
    ...
    "Restaurant De Salentein B.V.",
    "Restaurant King of India",
    "Result Financiële Dienstverlening B.V.",
    "Resumedia B.V.",
    "Retail Unity B.V.",
    ...
    "Returnista B.V.",
    "Reunion Ventures B.V.",
    "Revantage Europe Netherlands B.V.",
    "ReviMedia B.V.",
    "Revinate B.V.",
    ...
    "Rijkswaterstaat",
    "Rijnboutt B.V.",
    "Rijnmond Maintenance Services B.V.",
    ...
    "Riverty Services Netherlands B.V.",
    ...
    "Rock Payroll B.V.",
    "Rocket Software B.V.",
    "Rockfeather Data Vizualization B.V.",
    ...
    "RSM Netherlands Financial Advisory Services B.V.",
    ...
    "Sapporo Europe B.V.",
    "Sarten Packaging Netherlands B.V.",
    "Sartorius Netherlands B.V.",
    "Sas Institute B.V.",
    "Sasja Careers B.V.",
    "Sasma B.V.",
    "Sasol Holding (Netherlands) B.V.",
    "Satelligence B.V.",
    "Satelligence B.V.",
    "Satellogic Netherlands B.V.",
    ...
    "Scenic Biotech B.V.",
    "Scenius Software Engineering B.V.",
    "Scenwise B.V.",
    "Schaaf- en Boorwerk Rotterdam B.V.",
    "Schaffelaarbos B.V.",
    ...
    "Schuiteman Audit & Assurance B.V.",
    "Schuiteman Corporate Finance B.V.",
    ...
    "Seco Tools B.V.",
    "Second Company B.V.",
    "Second Company International B.V.",
    ...
    "Sedef Impex Groenten & Fruit B.V.",
    "See the Good B.V.",
    "See Tickets B.V.",
    "SEEBURGER Benelux",
    "SeeCubic B.V.",
    ...
    "Sendmarc Europe B.V.",
    "Sendsteps B.V.",
    "Senkron Energy Digital Services B.V.",
    "sennder Benelux B.V.",
    ...
    "Sensity B.V.",
    "Sensixs Design B.V.",
    "Sensor Netherlands B.V.",
    "Sensor West B.V.",
    "Sensorfact B.V.",
    "Sensorfy B.V.",
    "Sensoterra International B.V.",
    "Sensys Gatso International B.V.",
    ...
    "Shifter Zakelijke dienstverlening B.V.",
    "Shimano Europe B.V.",
    "SHINE Europe B.V.",
    ...
    "Shopify Commerce Netherlands B.V.",
    "Shopping Minds Nederland B.V.",
    "ShoreTension B.V.",
    ...
    "Sidhu Food B.V.",
    "Siebel Jewelry B.V.",
    "Siemens Electronic Design Automation B.V.",
    "Siemens Energy B.V.",
    ...
    "Siere Handel B.V.",
    "Sierra Instruments B.V.",
    "Sif Netherlands B.V.",
    "Siflower Communication Holland B.V.",
    "Sig Combibloc B.V.",
    ...
    "Simply Green B.V.",
    "Simptel B.V.",
    "SimStudio International Consultants B.V.",
    "Simtech Cloud Consulting B.V.",
    "SIMtoCARE B.V.",
    "Simwave B.V.",
    "Simytech Uitzend- en Detacheringsbureau Hengelo B.V.",
    "Sineria Holland B.V.",
    ...
    "Sintecs B.V.",
    "Sioux Expats B.V.",
    "Sioux Technologies Assembly B.V.",
    "Siqura B.V.",
    ...
    "Sjaak van Schie B.V.",
    "Sjartec Technische Groothandel B.V.",
    ...
    "Sledge Hammer Engineering International B.V.",
    ...
    "Smallsteps B.V.",
    "Smarlet RPM B.V.",
    "Smart Asset Integrity Solutions B.V.",
    "Smart Compliance Solution B.V.",
    "Smart Grid B.V.",
    "Smart Medical and Trade B.V.",
    "SMART Photonics B.V.",
    "Smart Robotics B.V.",
    "Smart.pr B.V.",
    "Smart2IT B.V.",
    ...
    "Sojitz Aviation and Marine B.V.",
    ...
    "Solulever B.V.",
    "Solutional Consulting B.V.",
    "Solutional Netherlands B.V.",
    "Solvès Employee B.V.",
    "Solvinity",
    "Solvy B.V.",
    "Somar Europe B.V.",
    "Somatics Incubator B.V.",
    ...
    "Soterion Benelux B.V.",
    "Soulpicks B.V.",
    "Soulve Innovations B.V.",
    "Soundclaims B.V.",
    "SoundEnergy B.V.",
    "Source Engineering Services B.V.",
    "Source Flex Solutions B.V.",
    "Source Payroll Services B.V.",
    "Source.ag B.V.",
    "Source.ag International B.V.",
    "Sourcenext B.V.",
    "Soursop B.V.",
    "South Pole Netherlands B.V.",
    "South Stream Transport B.V.",
    "Sovereign Speed Netherlands B.V.",
    "Sowiso B.V.",
    ...
    "space&matter B.V.",
    "Space4Good B.V.",
    "Spacewell Netherlands B.V.",
    "SPAR International B.V.",
    "Sparck Technologies Services B.V.",
    "Spares in Motion B.V.",
    "Spark Design & Innovation B.V.",
    "Spark Universe B.V.",
    "Sparkelon B.V.",
    "SparkNano B.V.",
    "Sparkoo Technologies B.V.",
    "SparkOptimus B.V.",
    "Sparque B.V.",
    "Spatial Eye B.V.",
    ...
    "Sqills Products B.V.",
    "SQLI Nederland B.V.",
    "Squadra MDM Factory B.V.",
    "Squarespace Netherlands B.V.",
    "Squeezely B.V.",
    "SR CON NH B.V.",
    "SRA (Europe) B.V.",
    ...
    "Staffyou Service & Software B.V.",
    "STAG Hotels Netherlands B.V.",
    ...
    "Statkraft Renewables Benelux B.V.",
    "STBY B.V.",
    "STC - Group",
    "STC B.V.",
    ...
    "Stellar Belastingadviseurs B.V.",
    "Stellar Data Recovery B.V.",
    "STELTIX Nederland B.V.",
    "Stena Line B.V.",
    "Ster innovation and consultancy B.V.",
    "Sterc B.V.",
    "STERIS",
    "Sthree Holdings B.V.",
    ...
    "Stijlgroep Landschap en Stedelijke Ruimte B.V.",
    "Stip Hilversum",
    "Stipt Employment Services B.V.",
    "Stiron B.V.",
    "Stitch Digital B.V.",
    "Stitch Heads B.V.",
    "STMP Holding B.V.",
    ...
    "StoryTEQ B.V.",
    "Straightforward",
    "Straight-Line Leadership Group B.V.",
    "Strattner B.V.",
    "Stratus Energy B.V.",
    "Straumann B.V.",
    "Strauss Coffee B.V.",
    ...
    "Super B Electronic Controllers B.V.",
    "Super B Engineering B.V.",
    "Super Micro Computer B.V.",
    "Super73 B.V.",
    "SuperHeroes Amsterdam B.V.",
    "Superimpose Architecture B.V.",
    "Superknowa B.V.",
    ...
    "supplai B.V.",
    "Supply Chain Company B.V.",
    "SurePay B.V.",
    "SURF B.V.",
    "SurfiX B.V.",
    "Surfly B.V.",
    "SurveyMonkey Netherlands B.V.",
    "SUSE Software Solutions Netherlands B.V.",
    "SusPhos B.V.",
    "Sustainable Apparel Coalition, Inc.",
    "Sustainable Buildings B.V.",
    "Sustainable Capital Group B.V.",
    "Sustainable Market Solutions Holding B.V.",
    "Sustainalytics B.V.",
    "Sustainer Homes B.V.",
    "Suster B.V.",
    "Sutinom B.V.",
    "Sutton Tools Europe B.V.",
    "Suzlon Energy Limited",
    "SUZOHAPP Netherlands B.V.",
    "Svea Solar Nederland B.V.",
    "Svitanok B.V.",
    "Svizera Europe B.V.",
    "SVP-Architektuur en Stedebouw",
    "Swancor Netherlands B.V.",
    "SwapServices B.V.",
    ...
    "Synopsys Software Netherlands B.V.",
    "Synova Coöperatief U.A.",
    "Synova Renewable Technology B.V.",
    "Synres B.V.",
    ...
    "Sytac B.V.",
    "Sytac Development B.V.",
    "Sytac Digital B.V.",
    "Sytac Technologies B.V.",
    "T&P Projecten B.V.",
    ...
    "Tandartsen Praktijk Zaandam B.V.",
    "Tandartsenpost Eindhoven B.V.",
    "Tandartsenpraktijk Bakel B.V.",
    "Tandartsenpraktijk DentWork",
    "Tandartsenpraktijk Karselaan",
    "Tandartsenpraktijk Mazairac B.V.",
    "Tandartsenpraktijk Nieuwe Steen B.V.",
    "Tandartsenpraktijk Ribic B.V.",
    "Tandartsenpraktijk Rotterdam Noord B.V.",
    "Tandartspraktijk Assenberg",
    "Tandartspraktijk Brummelhuis Oldenzaal B.V.",
    "Tandartspraktijk Daneshvar B.V.",
    "Tandartspraktijk Eemsmond B.V.",
    "Tandartspraktijk Elinkwijk B.V.",
    "Tandartspraktijk i-Dental",
    "Tandartspraktijk Julianadorp B.V.",
    "Tandartspraktijk Kamphuis B.V.",
    "Tandartspraktijk Palladino B.V.",
    ...
    "Tap Electric B.V.",
    "Tapfiliate B.V.",
    "TAPP Hospitality B.V.",
    "Target Recruitment B.V.",
    "Tarkett B.V.",
    "Tarmac Europe B.V.",
    "Tasking B.V.",
    "Tasman Analytics B.V.",
    ...
    "Tecforce Professionals Engineering and Construction Services B.V.",
    "Tecforce Professionals Engineering B.V.",
    "Tech Mahindra IT Services NL",
    "Tech Rise People B.V.",
    "Tech2Change B.V.",
    "Techathone Systems B.V.",
    "Techcross Europe",
    "Techlab B.V.",
    "TechMatch B.V.",
    "Technetix B.V.",
    ...
    "Technisch Adviesburo J.J.Th. Willems B.V.",
    ...
    "Tellart B.V.",
    "Tellow B.V.",
    "Telnyx Netherlands B.V.",
    "Telstar B.V.",
    "Tembo 4x4 e-LV B.V.",
    "Tembo Paper Straws B.V.",
    "TEMBOGROUP B.V.",
    "Temenos Holland B.V.",
    "Temper B.V.",
    "Temper Global B.V.",
    ...
    "Temporary Works Design 11 B.V.",
    "Temporary Works Design 12 B.V.",
    "Temporary Works Design 13 B.V.",
    "Temporary Works Design 14 B.V.",
    ...
    "TenBrasWestinga - architectuur interieur stedenbouw B.V.",
    "TenCate Geosynthetics Holding B.V.",
    ...
    "The Angel Foundation B.V.",
    "The Antenna Company Nederland B.V.",
    "The Asia Connection B.V.",
    "The Avocado Show Holding B.V.",
    "The Bank of New York Mellon SA/NV",
    "The BIM Engineers B.V.",
    "The Bookie B.V.",
    "The Boston Consulting Group B.V.",
    "The Brink Agency B.V.",
    "The British School in the Netherlands",
    "The British School of Amsterdam",
    "The Capitals B.V.",
    "The Chiropractor",
    "The Chiropractor B.V.",
    "The Contractors Company B.V.",
    "The Creative Productivity Group N.V.",
    "The Data Agency B.V.",
    "The Data Cooks B.V.",
    "The Digital Neighborhood B.V.",
    ...
    "The Hash Eatery B.V.",
    "The Hyve B.V.",
    "The International Butler Academy B.V.",
    "The Internet & Cable Company (TICC) B.V.",
    "The Kingfish Company N.V.",
    "The Live Kindly Collective",
    "The Logic Factor B.V.",
    "The Lost Explorer Mezcal Company B.V.",
    "The Maastricht Forensic Institute B.V.",
    "The Makers B.V.",
    "The MathWorks B.V.",
    "The Networkers B.V.",
    "The New Amsterdam Group B.V.",
    ...
    "thetruthworks B.V.",
    "thinkproject BeNeLux B.V.",
    "ThinkWings Netherlands B.V.",
    "Thinkwise Software B.V.",
    "Thirdera NLD B.V.",
    "Thirona B.V.",
    "This is Development B.V.",
    "This Play Media B.V.",
    "ThisWorks EOR Services B.V.",
    "T-Hive B.V.",
    "Thomas Miller B.V.",
    ...
    "Thonik B.V.",
    "Thorizon Engineering B.V.",
    "ThoughtLine Europe B.V.",
    "Thoughtworks Netherlands B.V.",
    "ThreatFabric B.V.",
    "Threeforce B.V.",
    "Threshold Inspection & Application Training Europe B.V.",
    "THRIVE Chiropractic B.V.",
    "THS EU B.V.",
    "Thuja Capital Management B.V.",
    "Thunderbyte.AI B.V.",
    "Thunderhead B.V.",
    "Thus Meddens Mudde Technology B.V.",
    "thyssenkrupp Liften B.V.",
    "TiasNimbas Business School",
    "Tibber Netherlands B.V.",
    "Tiberone Europe B.V.",
    "TicketSwap B.V.",
    "Tideworks Netherlands B.V.",
    "TIE Kinetix Holding B.V.",
    "TIE Kinetix N.V.",
    "TIE Product Development B.V.",
    "Tieto Netherlands B.V.",
    "Tiger Stores Nederland B.V.",
    "TikTok Netherlands B.V.",
    "TikTok Technologies Netherlands B.V.",
    "Tiledmedia Operations B.V.",
    "TIM III B.V.",
    "Time Shift B.V.",
    "Time4T Nederland B.V.",
    "TimeWax B.V.",
    "Timex Nederland B.V.",
    "Timko B.V.",
    "Timmers Engineering B.V.",
    "Timpel Medical B.V.",
    "Timver B.V.",
    "Tinka Holding B.V.",
    "Tintel B.V.",
    ...
    "TOPCHIRO Den Bosch B.V.",
    "TopChiro Rotterdam B.V.",
    "TOPCHIRO Weert B.V.",
    ...
    "Tosoh Europe BV",
    "TOSS in Holland B.V.",
    "Total Concept Group B.V.",
    "Total Design B.V.",
    "Total Impact Capital Europe B.V.",
    ...
    "Transplace Europe Holdings B.V.",
    ...
    "Tulsie B.V.",
    "Tune4solutions B.V.",
    "Tupy Materials & Components B.V.",
    "Turbo Blower Service B.V.",
    "Turbo Systems The Netherlands B.V.",
    "Turff B.V.",
    ...
    "Unis Group Facilities B.V.",
    "Unis Group R&D B.V.",
    "Unispace B.V.",
    "Unisun Energy B.V.",
    "Unisys Nederland N.V.",
    "Unit U Professionals B.V.",
    "Unit040 Ontwerp B.V.",
    ...
    "United Petfood Nederland B.V.",
    "United World College Maastricht",
    "Unitron InnoTech B.V.",
    "Unitura B.V.",
    "Unity Monetary Services B.V.",
    "Univar Solutions",
    "Univé Dichtbij Organisatie B.V.",
    "Universal Africa Lines B.V.",
    ...
    "UST Global (Netherlands) B.V.",
    "UT Quality B.V.",
    "Utilus B.V.",
    "Utomik Development B.V.",
    "Utopia Exploitatie B.V.",
    "Utr8 Holding B.V.",
    "Utrechtse Zwemclub-Star-Combinatie (U.Z.S.C.)",
    "Uxus Europe B.V.",
    "V.B.I. Ontwikkeling B.V.",
    ...
    "Van Eeghen Functional Ingredients B.V.",
    ...
    "Van Noort Gassler & Co Rotterdam B.V.",
    "Van Oers Snacks B.V.",
    "Van Ommeren Architecten B.V.",
    ...
    "Van Storm B.V.",
    "Van Storm Projects B.V.",
    "Van Vredenburghweg B.V.",
    "Van Wijnen Components B.V.",
    "Van Wijnen Engineering Dordrecht B.V.",
    ...
    "VHP Security Paper B.V.",
    "VI Technologies B.V.",
    "ViaEurope B.V.",
    "Vialis B.V.",
    "Viaplay Group Netherlands B.V.",
    ...
    "Vibrantz Color Solutions Europe B.V.",
    ...
    "Viktor & Rolf B.V.",
    "Villa Parmentier B.V.",
    "Villares Metals International B.V.",
    "VIM B.V.",
    "VIM Group Brand Implementation B.V.",
    "VIMEC",
    "VIMN Netherlands B.V.",
    "Vinmar International B.V.",
    "VINNO Technology NL B.V.",
    "Vinted B.V.",
    "Vintura B.V.",
    "Vinturas B.V.",
    ...
    "Visa Service Desk Beheer B.V.",
    "Viscon Plant Technology B.V.",
    "Vish Psychiatrische Praktijk",
    "ViSight B.V.",
    "VisionBI B.V.",
    "VisionLabs B.V.",
    "Visionnav Robotics Europe B.V.",
    "Visionplanner B.V.",
    "VisionWillow B.V.",
    "Visiopharm NL B.V.",
    "Visma Connect",
    ...
    "Voormedia B.V.",
    "Voort B.V.",
    "Voortman Sales & Engineering B.V.",
    "Vopak Global IT B.V.",
    "Vopak LNG Holding B.V.",
    "Vormats B.V.",
    "Vos Investments Beheer B.V.",
    "Vos Prodect Innovations B.V.",
    "Voskamp Aluminium B.V.",
    "Vosta LMG B.V.",
    "VOVB en Partners B.V.",
    "Voxius Lease a Lawyer B.V.",
    "VPK Packaging B.V.",
    "VR European Holdings B.V.",
    "VRAIFUTURE B.V.",
    "VREMAC Cylinders",
    "Vriesoord B.V.",
    "Vripack Design B.V.",
    "VROEGH Design B.V.",
    "Vroom Consultancy B.V.",
    "Vroon B.V.",
    "VRP Consulting B.V.",
    "Vruchtvlees B.V.",
    "Vrumona B.V.",
    ...
    "Vye Consulting B.V.",
    "Vynova Beek B.V.",
    "Vysus Netherlands B.V.",
    "W&O Personeels-B.V.",
    "W.B. Stables",
    "W.digital B.V.",
    "W.E. Engineering B.V.",
    "W.F. Westermann & Co. B.V.",
    "W.P. Carey & Co. B.V.",
    "W.P. van Acker B.V.",
    "W.R. Fibers B.V.",
    ...
    "Wecountancy Expat Services B.V.",
    "WeekCal B.V.",
    ...
    "Westport Fuel Systems Netherlands B.V.",
    ...
    "Winc Academy B.V.",
    "Winclove B.V.",
    "Windcat Workboats International B.V.",
    "Winteb B.V.",
    "Wintershall Dea Carbon Management Solutions B.V.",
    ...
    "Wolters Kluwer Tax and Accounting Nederland B.V.",
    ...
    "Woonwerk Architecten Rotterdam B.V.",
    "WOOV-IT B.V.",
    "Workday B.V.",
    "Workersbee Energy B.V.",
    "WorkFloor B.V.",
    "WorkFlowWise B.V.",
    ...
    "Wunderman Thompson Commerce B.V.",
    "Wunderman Thompson Technology B.V.",
    ...
    "Xlence Renovatie B.V.",
    "Xomnia B.V.",
    "XOsight B.V.",
    "XPAR Vision B.V.",
    "XPark B.V. i.o.",
    "XPeng European Holding B.V.",
    "Xperit Solutions B.V.",
    "Xpol B.V.",
    "Xprtise B.V.",
    "XR Trading EU B.V.",
    "XS Investments B.V.",
    ...
    "Yinson Production (The Netherlands) B.V.",
    ...
    "YunExpress Supply Chain Solution B.V.",
    ...
    "ZIEATECH B.V.",
    "ZIEMANN Cashservice Holding NL B.V.",
    "Ziggo B.V.",
    ...
    "Zonnepark Services Nederland B.V.",
    "Zonnestroom Nederland B.V.",
    "Zoofy B.V.",
    "Zoom-BIM Solutions B.V.",
    "ZooStation B.V.",
    "Zoover Media B.V.",
  ...
  // Sort the companies by length in descending order
  companies.sort((a, b) => b.length - a.length);
  
  // Store the companies list in storage
  browser.storage.local.set({ companies });
  
  // Fetch the list when the extension is installed or updated
  browser.runtime.onInstalled.addListener(() => {
    browser.storage.local.set({ companies });
  });
  
  // Fetch the list daily (although unnecessary with hard-coded list)
  setInterval(() => {
    browser.storage.local.set({ companies });
  }, 24 * 60 * 60 * 1000);
